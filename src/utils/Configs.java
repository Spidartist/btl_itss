...
public class Configs {
	...
	public static final String PHAN_HOI_SCREEN_PATH = "/views/fxml/phanhoi-view.fxml";
	public static final String DETAIL_PHAN_HOI_VIEW_FXML = "/views/fxml/phanhoi-detail-view.fxml";
	
	public static final String GOI_TAP_DA_DANG_KI_SCREEN_PATH = "/views/fxml/goitapdangki-view.fxml";
	public static final String DETAIL_GOI_TAP_DA_DANG_KI_VIEW_FXML = "/views/fxml/goitapdangki-detail-view.fxml";
	
	public static final String LICH_SU_DI_TAP_SCREEN_PATH = "/views/fxml/lichsu-view.fxml";
	public static final String DETAIL_LICH_SU_DI_TAP_VIEW_FXML = "/views/fxml/lichsu-detail-view.fxml";
